 ...
 * 
 * @export
 * @interface HelloControllerApiInterface
 */
export interface HelloControllerApiInterface {
     ...
     */
    helloRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>>;

    /**
     */
    hello(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string>;
 ...
 * 
 */
export class HelloControllerApi extends runtime.BaseAPI implements HelloControllerApiInterface {
